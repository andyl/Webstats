defmodule BadgerJob do
  alias BadgerData.Repo
  # alias BadgerData.Ctx.Account.Register
  # alias BadgerData.Ctx.Account.Folder
  # alias BadgerData.Ctx.News.Post
  # alias BadgerData.Ctx.News.Feed
  ...
  #     sync(feed)
  #     BadgerWeb.Endpoint.broadcast_from(self(), "read_all", "sync_feed", %{})
  #   else
  ...
  #   Logger.info "----- FEED SYNC --------------------------"
  #   touch(feed)
  #   case BadgerClient.scan(feed.url) do
